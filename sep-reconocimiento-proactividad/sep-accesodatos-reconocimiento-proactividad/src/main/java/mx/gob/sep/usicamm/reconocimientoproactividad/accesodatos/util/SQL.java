...
public enum SQL {
    ...
    public static final String SQL_BIT_REGISTRO_PARTICIPACION="INSERT INTO bitacora_abc_sistemas(nombre_tabla, cve_sistema_informacion, cve_tipo_movimiento, cve_docente_modificada, cve_docente_quien_modifica, atributos) SELECT 'registro_reconocimiento_proactividad_participacion', ?, ?, ?, ?, JSON_OBJECT('rid', rid, 'cve_cat_nivel_educativo', cve_cat_nivel_educativo, 'cve_docente', cve_docente, 'cve_cat_entidad_federativa', cve_cat_entidad_federativa, 'anio_aplicacion', anio_aplicacion, 'cve_cat_tipo_sostenimiento', cve_cat_tipo_sostenimiento, 'cve_cat_servicio_educativo', cve_cat_servicio_educativo, 'cve_cat_modalidad', cve_cat_modalidad, 'cve_cat_cct', cve_cat_cct, 'fecha_registro', fecha_registro, 'fecha_creacion', fecha_creacion, 'fecha_ultima_actualizacion', fecha_ultima_actualizacion) json FROM registro_reconocimiento_proactividad_participacion WHERE cve_cat_nivel_educativo=? AND cve_docente=? AND cve_cat_entidad_federativa=? AND anio_aplicacion=?;";
