...
public enum SQL {
    ...
    // --- Registro ---
    public static final String SQL_INS_REGISTRO_PARTICIPACION="INSERT INTO registro_reconocimiento_proactividad_participacion(cve_cat_nivel_educativo, cve_docente, cve_cat_entidad_federativa, anio_aplicacion, cve_cat_tipo_sostenimiento, cve_cat_servicio_educativo, cve_cat_modalidad, cve_cat_cct, huella, fecha_registro) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, NOW());";
